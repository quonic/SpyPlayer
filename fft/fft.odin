...
// Source: https://github.com/algo-boyz/odins-raylib/blob/master/rlutil/fft/fft.odin
// License: https://github.com/algo-boyz/odins-raylib/blob/master/LICENSE
/*
...
- Vishal
- x32dev
- William (glassyeyedfish)
- Ben Smith (smithbm2316)
- Jesus Marron (marron7)
- Evan Martinez (@Nave55)
- Christian Koch (Clear Code)
- Adrian Mirea (danadrianmirea)
- German Adrian Hoyos
- Jorge Villegas (jorgevee)
- Sven Woldt (go-dockly)
...
applications, and to alter it and redistribute it freely, subject to the following restrictions:
  ...
  in the products documentation would be appreciated but is not required.
